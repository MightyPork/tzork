...
a.style.opacity=0;setTimeout(function(){a.style.display="none"},500)}var people_orig;(function(){var m;var a;var g;var j;var b;var f=true;function k(){var p;if(f){people_orig=JSON.parse(JSON.stringify(people));

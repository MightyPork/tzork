...
}var a=moment().tz(c);return a.hour()*3600+a.minute()*60+a.second()}var disc;function init(){disc=document.getElementById("disc");buildClockMarks();update();setInterval(update,1000*30);setInterval(changeColon,1000);

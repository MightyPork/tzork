...
a.style.opacity=0;setTimeout(function(){a.style.display="none"},500)}var people_orig;(function(){var m;var a;var g;var j;var b;var f=true;function k(){var p;if(f){resolvePeopleTimezones(function(){people_orig=JSON.parse(JSON.stringify(people));
people_orig.forEach(function(r){delete r._t;delete r._valid;delete r._tz_cached})});var n=document.getElementsByTagName("textarea");var q=n.length;for(p=0;p<q;p++){n[p].onkeydown=function(t){if(t.keyCode==9||t.which==9){t.preventDefault();
var r=this.selectionStart;this.value=this.value.substring(0,this.selectionStart)+"\t"+this.value.substring(this.selectionEnd);this.selectionEnd=r+1}}}f=false}var o=document.querySelectorAll(".mark, .bullet, .person-label, .people-list");

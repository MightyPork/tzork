...
var a=document.createElement(c?"a":"span");a.classList.add("person-label");if(c){a.href="https://twitter.com/"+b.name;a.classList.add("twitter-link");a.target="_blank"}a.style.color=b.color;a.textContent=b.name;
return a};